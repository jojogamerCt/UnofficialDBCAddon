    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (!this.worldObj.isRemote && !this.isDead) {
            ...
            if (flag || this.getDamageTaken() > 1.0f) {
                ...
                this.func_145778_a(ItemsDBC.KintounItem, 1, 0.0f);
                if (!flag) {
                    // empty if block
                }
                this.setDead();
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (list != null && !list.isEmpty()) {
                    for (l = 0; l < list.size(); ++l) {
                        ...
                        if (entity == this.riddenByEntity || !entity.canBePushed() || !(entity instanceof KintounEntity)) continue;
                        this.motionX = 0.0;
                        this.motionY = 0.0;
                        this.motionZ = 0.0;
                    }
