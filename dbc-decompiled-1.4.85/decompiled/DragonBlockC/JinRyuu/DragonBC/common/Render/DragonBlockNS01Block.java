...
public class DragonBlockNS01Block
extends BlockContainer {
    private Class DragonBlockNS01TileEntity = DragonBlockNS01TileEntity.class;
    private static int tickDragonBall = 0;
    int port1 = 0;

    public DragonBlockNS01Block() {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (!par1World.isRemote && par5Random.nextInt(5) == 0) {
            par1World.setBlock(par2, par3, par4, BlocksDBC.BlockNamekDragonBall);
        }
    }
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        ...
        DragonBlockNS01Block block = item instanceof ItemBlock && !this.isFlowerPot() ? Block.getBlockFromItem((Item)item) : this;
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new DragonBlockNS01TileEntity();
    }
}
