...
extends Entity {
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.isRemote && this.riddenByEntity != null && this.riddenByEntity instanceof EntityPlayer) {
            boolean isKOd;
            NBTTagCompound tag = JRMCoreH.nbt((Entity)((EntityPlayer)this.riddenByEntity), (String)"pres");
            boolean bl = isKOd = tag.getInteger("jrmcHar4va") > 0;
            if (isKOd) {
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty) {
            ...
            this.moveEntity(this.motionX * DBCConfig.cnfSpc, this.motionY * DBCConfig.cnfSpc, this.motionZ * DBCConfig.cnfSpc);
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (list != null && !list.isEmpty()) {
                    for (l = 0; l < list.size(); ++l) {
                        ...
                        if (entity == this.riddenByEntity || !entity.canBePushed() || !(entity instanceof SpacePod01Entity)) continue;
                        this.motionX = 0.0;
                        this.motionY = 0.0;
                        this.motionZ = 0.0;
                    }
    ...
    public void dri(int a) {
        float s = this.riddenByEntity != null ? this.dS : 0.0f;
        PD.sendTo((IMessage)new DBCPdri((int)(s * 10.0f)), (EntityPlayerMP)((EntityPlayerMP)this.riddenByEntity));
    }
