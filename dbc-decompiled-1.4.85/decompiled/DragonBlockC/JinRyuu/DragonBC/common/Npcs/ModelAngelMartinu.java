...
extends ModelBase {
    ...
    public ModelAngelMartinu() {
        ...
        this.NeckRing_3.addBox(-8.7f, -2.5f, -3.2f, 2, 1, 7, 0.0f);
        ...
        this.NeckRing_4.addBox(-8.5f, -2.5f, -3.3f, 2, 1, 7, 0.0f);
        ...
        this.LegR2.addBox(-3.3f, 0.1f, -4.2f, 6, 8, 8, 0.0f);
        this.ArmL = new ModelRenderer((ModelBase)this, 82, 21);
        this.ArmL.mirror = true;
        this.ArmL.setRotationPoint(6.2f, 1.3f, -0.2f);
        ...
        this.Hair2.addBox(-3.5f, -5.2f, 1.8f, 7, 2, 3, 0.0f);
        ...
        this.NeckRing_6.addBox(-8.3f, -2.5f, -5.5f, 2, 1, 9, 0.0f);
        ...
        this.NeckRing_2.addBox(-8.7f, -2.5f, -3.9f, 2, 1, 9, 0.0f);
        this.setRotateAngle(this.NeckRing_2, 0.0f, -0.82833326f, 0.0f);
        this.ClothF = new ModelRenderer((ModelBase)this, 36, 51);
        this.ClothF.setRotationPoint(0.0f, 10.3f, -3.8f);
        this.ClothF.addBox(-3.5f, -0.1f, -0.5f, 7, 11, 0, 0.0f);
        ...
        this.NeckRing.addBox(-3.5f, -2.5f, 7.9f, 7, 1, 2, 0.0f);
        ...
        this.Body2.addBox(-5.5f, 5.1f, -3.9f, 11, 5, 7, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 82, 21);
        this.ArmR.setRotationPoint(-6.2f, 1.3f, -0.2f);
        ...
        this.ShoulderL.addBox(-1.2f, -2.5f, -1.9f, 4, 4, 4, 0.0f);
        ...
        this.NeckRing_5.addBox(-8.3f, -2.5f, -3.3f, 2, 1, 7, 0.0f);
        ...
        this.Boobs.addBox(-4.5f, 3.7f, -1.1f, 9, 3, 3, 0.0f);
