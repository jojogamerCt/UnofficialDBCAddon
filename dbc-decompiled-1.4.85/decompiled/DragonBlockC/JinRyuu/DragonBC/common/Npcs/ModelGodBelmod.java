...
extends ModelBase {
    ...
    public ModelGodBelmod() {
        ...
        this.Head.addBox(-4.0f, -7.8f, -4.0f, 8, 8, 8, -0.3f);
        this.LegR2 = new ModelRenderer((ModelBase)this, 3, 29);
        this.LegR2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegR2.addBox(-2.1f, 0.0f, -2.0f, 4, 12, 4, 0.0f);
        this.Nose = new ModelRenderer((ModelBase)this, 25, 1);
        this.Nose.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Nose.addBox(-1.0f, -3.8f, -4.9f, 2, 1, 2, 0.0f);
        this.Neck = new ModelRenderer((ModelBase)this, 33, 10);
        this.Neck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Neck.addBox(-2.0f, -0.5f, -0.8f, 4, 2, 2, 0.0f);
        this.LegL2 = new ModelRenderer((ModelBase)this, 3, 47);
        this.LegL2.mirror = true;
        this.LegL2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegL2.addBox(-1.9f, 0.0f, -2.0f, 4, 12, 4, 0.0f);
        this.Cloth1 = new ModelRenderer((ModelBase)this, 47, 35);
        this.Cloth1.setRotationPoint(0.0f, 9.9f, -1.8f);
        ...
        this.Body2.addBox(-2.9f, 5.0f, -1.7f, 6, 3, 3, 0.0f);
        ...
        this.LegL = new ModelRenderer((ModelBase)this, 37, 53);
        this.LegL.mirror = true;
        this.LegL.setRotationPoint(1.9f, 12.0f, 0.0f);
        this.LegL.addBox(-1.7f, 3.3f, -2.0f, 4, 6, 4, 0.3f);
        ...
        this.Hair.addBox(-5.5f, -7.1f, 0.0f, 11, 4, 5, 0.0f);
        this.LegR = new ModelRenderer((ModelBase)this, 21, 53);
        this.LegR.setRotationPoint(-1.9f, 12.0f, 0.0f);
        this.LegR.addBox(-2.4f, 3.3f, -2.0f, 4, 6, 4, 0.3f);
