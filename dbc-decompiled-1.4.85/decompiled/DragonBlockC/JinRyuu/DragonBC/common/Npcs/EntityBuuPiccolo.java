...
extends EntityDBCEvil {
    ...
    public final int HePo = 68000;
    private int target;

    public EntityBuuPiccolo(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "superMajinBuu_Piccolo";
        this.setData2(3);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(68000.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(6800.0);
    }
