...
public class EntityDBMasterRoshi2
extends EntityDBCEvil {
    public String tex;
    public final int AttPow = 90;
    public final int HePo = 200;

    public EntityDBMasterRoshi2(World par1World) {
        super(par1World);
        this.experienceValue = 10;
        this.tex = "master_roshi_max_power";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(90.0);
    }
