...
extends ModelBase {
    ...
    public ModelBearThief() {
        ...
        this.Hair.setRotationPoint(0.0f, -5.0f, -0.5f);
        this.Hair.addBox(-0.5f, -3.0f, -4.0f, 1, 3, 7, 0.0f);
        ...
        this.EarR.setRotationPoint(-3.8f, -4.4f, -1.0f);
        ...
        this.Nose.setRotationPoint(0.0f, -2.0f, -2.8f);
        ...
        this.EarL.setRotationPoint(3.2f, -4.4f, -1.0f);
