...
implements IMob {
    ...
    public EntityDino02(World par1World) {
        ...
        if (DBCConfig.NPC_Dino2_Dam != 40 || DBCConfig.NPC_Dino2_HP != 300) {
            this.getEntityData().setDouble("jrmcSpawnInitiatedCAT", (double)DBCConfig.NPC_Dino2_Dam);
            this.getEntityData().setDouble("jrmcSpawnInitiatedCHP", (double)DBCConfig.NPC_Dino2_HP);
        }
    }
