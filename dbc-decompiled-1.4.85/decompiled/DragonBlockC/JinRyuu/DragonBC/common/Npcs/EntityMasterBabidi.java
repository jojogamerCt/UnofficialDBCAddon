...
extends EntityDBCKami {
    ...
    public EntityMasterBabidi(World par1World) {
        ...
        if (this.dimension != 22 && this.dimension != 24) {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(1120.0);
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (this.isEntityAlive()) {
            par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 19, par1EntityPlayer.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            return true;
        }
