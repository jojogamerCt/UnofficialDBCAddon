...
extends ModelBase {
    ...
    public ModelCauliflaSSJ() {
        ...
        this.HairFrontL1.setRotationPoint(1.3f, -0.4f, -2.7f);
        ...
        this.HairR1.addBox(-2.6f, -6.5f, -2.0f, 4, 7, 4, 0.0f);
        ...
        this.HairL2.addBox(-3.3f, -1.9f, -0.5f, 4, 4, 5, 0.0f);
        ...
        this.HairL1.addBox(-1.9f, -6.5f, -2.0f, 4, 7, 4, 0.0f);
        ...
        this.HairR2.setRotationPoint(-2.7f, -0.1f, -0.1f);
        this.HairR2.addBox(-1.0f, -1.9f, -0.5f, 4, 4, 5, 0.0f);
        this.setRotateAngle(this.HairR2, 0.6981317f, -0.6981317f, -0.2268928f);
        this.HairFrontR2 = new ModelRenderer((ModelBase)this, 54, 5);
        this.HairFrontR2.setRotationPoint(-0.4f, -0.3f, -0.1f);
