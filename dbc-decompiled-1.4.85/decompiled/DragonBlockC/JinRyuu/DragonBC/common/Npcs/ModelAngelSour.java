...
extends ModelBase {
    ...
    public ModelAngelSour() {
        ...
        this.Neck = new ModelRenderer((ModelBase)this, 2, 20);
        ...
        this.HairL = new ModelRenderer((ModelBase)this, 54, 0);
        this.HairL.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.HairL.addBox(2.4f, 0.3f, -1.0f, 2, 2, 2, 0.0f);
        ...
        this.ArmR.addBox(-2.0f, -1.6f, -1.8f, 3, 13, 4, -0.1f);
        ...
        this.Hair1.addBox(-3.5f, -2.9f, -0.2f, 7, 5, 4, 0.0f);
        ...
        this.HairR = new ModelRenderer((ModelBase)this, 54, 0);
        this.HairR.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.HairR.addBox(-4.4f, 0.3f, -1.0f, 2, 2, 2, 0.0f);
        ...
        this.Head.addBox(-4.0f, -8.0f, -4.0f, 8, 9, 8, -0.8f);
        ...
        this.Hair1.addChild(this.HairL);
        ...
        this.Hair1.addChild(this.HairR);
