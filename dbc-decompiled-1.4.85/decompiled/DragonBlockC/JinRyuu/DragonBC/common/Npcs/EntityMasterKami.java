...
extends EntityDBCKami {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (this.isEntityAlive()) {
            par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 11, par1EntityPlayer.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            return true;
        }
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/kami.png";
    }
}
