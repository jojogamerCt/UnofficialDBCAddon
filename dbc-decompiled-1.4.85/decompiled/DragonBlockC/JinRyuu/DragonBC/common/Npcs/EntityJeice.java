...
public class EntityJeice
extends EntityDBCEvil {
    public int randomSoundDelay = 0;
    public final int AttPow = 160;
    public final int HePo = 1600;

    public EntityJeice(World par1World) {
        super(par1World);
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/jeice.png";
    }
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(160.0);
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                EntityJeice var7 = (EntityJeice)var6;
