...
extends ModelBase {
    ...
    public ModelAngelCukatail() {
        ...
        this.Body1 = new ModelRenderer((ModelBase)this, 17, 18);
        this.Body1.setRotationPoint(0.0f, -3.0f, 0.0f);
        this.Body1.addBox(-4.5f, 0.1f, -2.2f, 9, 7, 5, 0.0f);
        this.ArmL = new ModelRenderer((ModelBase)this, 48, 16);
        this.ArmL.mirror = true;
        this.ArmL.setRotationPoint(5.7f, -1.2f, 0.0f);
        this.ArmL.addBox(-1.2f, -1.5f, -1.8f, 4, 13, 4, -0.1f);
        ...
        this.NeckRing.setRotationPoint(0.0f, -0.3f, 0.4f);
        this.NeckRing.addBox(-3.5f, -1.5f, 7.9f, 7, 1, 2, 0.0f);
        this.setRotateAngle(this.NeckRing, 0.33004177f, 0.0f, 0.0f);
        this.Neck = new ModelRenderer((ModelBase)this, 5, 17);
        this.Neck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Neck.addBox(-2.5f, -0.9f, -0.8f, 5, 2, 3, 0.0f);
        ...
        this.LegR.setRotationPoint(-2.1f, 9.0f, 0.0f);
        this.LegR.addBox(-2.8f, 0.0f, -2.0f, 5, 15, 4, 0.0f);
        this.ShoulderArmorR = new ModelRenderer((ModelBase)this, 31, 9);
        this.ShoulderArmorR.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.ShoulderArmorR.addBox(-3.8f, -1.7f, -2.2f, 5, 4, 5, 0.0f);
        ...
        this.ClothF = new ModelRenderer((ModelBase)this, 47, 46);
        this.ClothF.setRotationPoint(0.0f, 6.9f, -2.0f);
        this.ClothF.addBox(-3.5f, 0.0f, 0.0f, 7, 5, 0, 0.0f);
        ...
        this.LegL.addBox(-2.0f, 0.0f, -2.0f, 5, 15, 4, 0.0f);
        this.Body3 = new ModelRenderer((ModelBase)this, 19, 38);
        this.Body3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body3.addBox(-4.5f, 9.0f, -2.0f, 9, 3, 4, 0.0f);
        this.Hair2 = new ModelRenderer((ModelBase)this, 30, 0);
        this.Hair2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hair2.addBox(-2.0f, -7.5f, 5.3f, 4, 3, 4, 0.0f);
        this.Hair1 = new ModelRenderer((ModelBase)this, 30, 0);
        this.Hair1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hair1.addBox(-3.0f, -7.3f, 2.6f, 6, 4, 4, 0.0f);
        ...
        this.ClothB2.addBox(-3.5f, 0.0f, 0.0f, 7, 11, 0, 0.0f);
        ...
        this.Body2 = new ModelRenderer((ModelBase)this, 20, 31);
        this.Body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body2.addBox(-4.0f, 7.1f, -1.9f, 8, 2, 4, 0.0f);
        this.LegL2 = new ModelRenderer((ModelBase)this, 18, 47);
        this.LegL2.mirror = true;
        this.LegL2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegL2.addBox(-2.0f, 13.1f, -4.0f, 5, 2, 2, 0.0f);
        this.ClothB = new ModelRenderer((ModelBase)this, 47, 46);
        this.ClothB.setRotationPoint(0.0f, 7.0f, 2.8f);
        this.ClothB.addBox(-3.5f, 0.0f, 0.0f, 7, 5, 0, 0.0f);
        this.setRotateAngle(this.ClothB, 0.054105207f, 0.0f, 0.0f);
        this.Head = new ModelRenderer((ModelBase)this, 0, 0);
        this.Head.setRotationPoint(0.0f, -3.9f, 0.0f);
        this.Head.addBox(-3.5f, -7.5f, -4.0f, 7, 8, 8, -0.4f);
        this.ClothF2 = new ModelRenderer((ModelBase)this, 33, 46);
        this.ClothF2.setRotationPoint(0.0f, 4.9f, 0.0f);
        this.ClothF2.addBox(-3.5f, 0.0f, 0.0f, 7, 11, 0, 0.0f);
        this.setRotateAngle(this.ClothF2, -0.010471975f, 0.0f, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 48, 16);
        this.ArmR.setRotationPoint(-5.7f, -1.2f, 0.0f);
        this.ArmR.addBox(-2.8f, -1.5f, -1.8f, 4, 13, 4, -0.1f);
        this.Hair3 = new ModelRenderer((ModelBase)this, 51, 0);
        this.Hair3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hair3.addBox(-1.0f, -6.5f, 8.5f, 2, 3, 2, 0.0f);
        this.LegR2 = new ModelRenderer((ModelBase)this, 18, 47);
        this.LegR2.mirror = true;
        this.LegR2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegR2.addBox(-2.8f, 13.1f, -4.0f, 5, 2, 2, 0.0f);
        this.ShoulderArmorL = new ModelRenderer((ModelBase)this, 31, 9);
        this.ShoulderArmorL.mirror = true;
        this.ShoulderArmorL.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.ShoulderArmorL.addBox(-1.2f, -1.7f, -2.2f, 5, 4, 5, 0.0f);
