...
extends ModelBase {
    ...
    public ModelKeflaSSJ() {
        ...
        this.Hair1.setRotationPoint(-0.2f, -7.0f, -0.3f);
        ...
        this.Hair7.setRotationPoint(-1.1f, -7.3f, 0.7f);
        this.Hair7.addBox(-2.6f, -6.3f, -2.0f, 4, 7, 4, 0.0f);
        this.setRotateAngle(this.Hair7, -0.40142572f, -0.13665928f, -0.2268928f);
        this.Hair9 = new ModelRenderer((ModelBase)this, 44, 19);
        this.Hair9.setRotationPoint(2.9f, -4.1f, -0.1f);
        this.Hair9.addBox(-3.3f, -1.9f, -0.7f, 4, 4, 6, 0.0f);
        ...
        this.Hair11.setRotationPoint(-2.1f, -1.8f, 0.4f);
        this.Hair11.addBox(-1.0f, -0.6f, 0.1f, 2, 1, 4, 0.0f);
        ...
        this.Hair10.mirror = true;
        this.Hair10.setRotationPoint(2.5f, -2.0f, 0.4f);
        this.Hair10.addBox(-1.0f, -1.0f, -0.1f, 2, 1, 4, 0.0f);
        ...
        this.Hair8.setRotationPoint(1.4f, -6.3f, 0.7f);
        this.Hair8.addBox(-1.9f, -6.5f, -2.0f, 4, 7, 4, 0.0f);
        ...
        this.Hair6.setRotationPoint(-2.7f, -4.3f, -0.1f);
        this.Hair6.addBox(-1.0f, -1.9f, -0.5f, 4, 4, 6, 0.0f);
