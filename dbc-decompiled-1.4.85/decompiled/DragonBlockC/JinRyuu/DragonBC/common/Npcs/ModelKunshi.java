...
extends ModelBase {
    ...
    public ModelKunshi() {
        ...
        this.EarR.setRotationPoint(-3.0f, -2.5f, -0.5f);
        this.EarR.addBox(-5.0f, -1.5f, -0.3f, 5, 3, 0, 0.0f);
        this.setRotateAngle(this.EarR, 0.0f, 0.6981317f, 0.0f);
        this.ArmL = new ModelRenderer((ModelBase)this, 40, 16);
        this.ArmL.mirror = true;
        this.ArmL.setRotationPoint(6.0f, 6.0f, 0.0f);
        this.ArmL.addBox(-1.0f, -2.0f, -2.0f, 4, 10, 4, 0.0f);
        ...
        this.Body2 = new ModelRenderer((ModelBase)this, 2, 27);
        this.Body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body2.addBox(-4.5f, 5.0f, -2.0f, 9, 1, 4, 0.0f);
        this.EarL = new ModelRenderer((ModelBase)this, 28, 1);
        this.EarL.mirror = true;
        this.EarL.setRotationPoint(3.0f, -2.5f, -0.5f);
        this.EarL.addBox(0.0f, -1.5f, -0.3f, 5, 3, 0, 0.0f);
        this.setRotateAngle(this.EarL, 0.0f, -0.6981317f, 0.0f);
        this.Head = new ModelRenderer((ModelBase)this, 0, 0);
        this.Head.setRotationPoint(0.0f, 4.3f, 0.0f);
        this.Head.addBox(-4.0f, -5.5f, -4.0f, 8, 6, 8, 0.0f);
        this.Body1 = new ModelRenderer((ModelBase)this, 1, 16);
        this.Body1.setRotationPoint(0.0f, 4.0f, 0.0f);
        this.Body1.addBox(-5.0f, 0.0f, -2.2f, 10, 5, 5, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 40, 16);
        this.ArmR.setRotationPoint(-5.9f, 6.0f, 0.0f);
        this.ArmR.addBox(-3.0f, -2.0f, -1.8f, 4, 10, 4, 0.0f);
        this.Body3 = new ModelRenderer((ModelBase)this, 2, 34);
        this.Body3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body3.addBox(-4.0f, 6.0f, -2.0f, 8, 4, 4, 0.0f);
