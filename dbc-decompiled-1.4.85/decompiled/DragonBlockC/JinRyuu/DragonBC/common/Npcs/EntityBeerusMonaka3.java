...
public class EntityBeerusMonaka3
extends EntityDBCEvil {
    ...
    public EntityBeerusMonaka3(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "beerus_monaka3";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(112000.0);
