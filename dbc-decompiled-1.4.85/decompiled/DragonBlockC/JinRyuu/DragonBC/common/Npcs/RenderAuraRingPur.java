...
public class RenderAuraRingPur
extends RenderDBC {
    ...
    public void renderAuraRingPur(EntityAuraRingPur par1Entity, double par2, double par4, double par6, float par8, float par9) {
        ...
        ResourceLocation txx = new ResourceLocation("jinryuudragonbc:auraringp.png");
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderAuraRingPur((EntityAuraRingPur)par1Entity, par2, par4, par6, par8, par9);
    }
}
