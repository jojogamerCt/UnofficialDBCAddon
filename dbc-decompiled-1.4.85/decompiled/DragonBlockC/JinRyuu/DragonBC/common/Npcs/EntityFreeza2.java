...
extends EntityDBCEvil {
    ...
    public EntityFreeza2(World par1World) {
        super(par1World);
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/freeza2.png";
    }
    ...
    public void onDeath(DamageSource par1DamageSource) {
        ...
        if (var3 instanceof EntityPlayer) {
            ((EntityPlayer)var3).addChatMessage(new ChatComponentTranslation(JRMCoreH.trlai((String)"dbc.itemFreeSagaFre.d.2.line1"), new Object[0]).setChatStyle(JRMCoreH2.styl_wht));
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                Entity var6 = (Entity)var4.get(var5);
                if (!(var6 instanceof EntityFreeza2)) continue;
                EntityFreeza2 var7 = (EntityFreeza2)var6;
                var7.becomeAngryAt(var3);
            }
            this.becomeAngryAt(var3);
        }
