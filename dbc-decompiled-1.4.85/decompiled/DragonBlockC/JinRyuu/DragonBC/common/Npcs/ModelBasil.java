...
extends ModelBase {
    ...
    public ModelBasil() {
        ...
        this.Back.setRotationPoint(0.0f, 1.6f, 3.0f);
        this.Back.addBox(-5.0f, 0.4f, 0.0f, 10, 12, 0, 0.0f);
        ...
        this.LegR2.addBox(-2.0f, 6.0f, -0.6f, 4, 7, 4, 0.0f);
        ...
        this.EarL.setRotationPoint(3.1f, -6.1f, 0.0f);
        ...
        this.ArmR.setRotationPoint(-5.0f, -1.0f, 0.5f);
        this.ArmR.addBox(-3.0f, -2.0f, -2.6f, 4, 5, 5, 0.0f);
        ...
        this.ArmL.setRotationPoint(5.0f, -1.0f, 0.5f);
        this.ArmL.addBox(-1.0f, -2.0f, -2.5f, 4, 5, 5, 0.0f);
        this.LegL2 = new ModelRenderer((ModelBase)this, 0, 53);
        this.LegL2.mirror = true;
        this.LegL2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegL2.addBox(-2.0f, 6.0f, -0.6f, 4, 7, 4, 0.0f);
        this.EarR = new ModelRenderer((ModelBase)this, 27, 2);
        this.EarR.setRotationPoint(-3.0f, -6.1f, 0.0f);
        ...
        this.Scarf.addBox(-4.5f, -1.0f, -3.8f, 9, 3, 8, 0.0f);
        ...
        this.ArmL2.addBox(-0.6f, 2.8f, -2.0f, 3, 9, 4, 0.0f);
        ...
        this.Fur.setRotationPoint(0.2f, 0.9f, -3.0f);
        this.Fur.addBox(-1.6f, -1.2f, -0.9f, 3, 3, 2, 0.0f);
        this.ArmR2 = new ModelRenderer((ModelBase)this, 0, 28);
        this.ArmR2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.ArmR2.addBox(-2.6f, 2.8f, -2.0f, 3, 9, 4, 0.0f);
        this.Scarf.addChild(this.Back);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.Back.rotateAngleX = -0.15f - MathHelper.cos((float)(par1 * 0.6662f)) * 1.2f * par2;
        if (0.0f > this.Back.rotateAngleX) {
            this.Back.rotateAngleX *= -1.0f;
        }
