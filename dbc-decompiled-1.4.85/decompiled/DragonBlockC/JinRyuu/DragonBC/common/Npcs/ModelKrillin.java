...
extends ModelBase {
    ...
    public ModelKrillin() {
        ...
        this.ArmL.setRotationPoint(4.3f, 5.6f, 0.4f);
        ...
        this.Belt3.setRotationPoint(0.3f, 6.4f, -1.9f);
        this.Belt3.addBox(-0.4f, 0.0f, 0.0f, 1, 5, 0, 0.0f);
        ...
        this.ArmR.setRotationPoint(-4.3f, 5.6f, 0.4f);
        ...
        this.Belt2.setRotationPoint(-0.4f, 6.4f, -1.9f);
        this.Belt2.addBox(-0.6f, 0.0f, 0.0f, 1, 5, 0, 0.0f);
        ...
        this.Belt.addBox(-3.1f, 5.5f, -1.7f, 6, 2, 3, 0.0f);
