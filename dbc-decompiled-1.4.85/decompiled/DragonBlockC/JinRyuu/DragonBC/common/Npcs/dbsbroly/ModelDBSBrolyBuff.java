...
extends ModelBase {
    ...
    public ModelDBSBrolyBuff() {
        ...
        this.Hair6.addBox(-1.1f, -6.6f, -1.9f, 3, 7, 5, 0.0f);
        ...
        this.ArmR1.setRotationPoint(-8.0f, -5.2f, 0.2f);
        ...
        this.Hair12.setRotationPoint(1.9f, -6.6f, -3.6f);
        ...
        this.Hair14.setRotationPoint(3.6f, -6.6f, -3.9f);
        ...
        this.Hair7.addBox(-1.3f, -3.7f, -2.4f, 4, 5, 5, 0.0f);
        ...
        this.Hair13.setRotationPoint(-0.9f, -7.3f, -3.9f);
        ...
        this.HairBack1.addBox(-4.0f, 0.0f, -0.5f, 8, 3, 2, 0.0f);
        ...
        this.Hair16.addBox(-1.0f, -5.1f, -1.8f, 3, 5, 5, 0.0f);
        ...
        this.Hair5.addBox(-1.0f, -2.8f, -0.8f, 2, 4, 3, 0.0f);
        ...
        this.Hair3.addBox(-0.9f, -2.8f, -0.7f, 2, 4, 3, 0.0f);
        ...
        this.ArmL1.addChild(this.ShoulderL);
