...
extends ModelBase {
    ...
    public ModelDBSParagus() {
        ...
        this.Beard = new ModelRenderer((ModelBase)this, 25, 1);
        this.Beard.setRotationPoint(0.0f, -2.7f, -3.8f);
        this.Beard.addBox(-3.0f, -0.1f, -0.25f, 6, 3, 0, 0.0f);
        ...
        this.ArmR = new ModelRenderer((ModelBase)this, 59, 15);
        this.ArmR.setRotationPoint(-5.0f, 2.0f, 0.0f);
        this.ArmR.addBox(-3.0f, -2.0f, -2.4f, 4, 13, 5, 0.0f);
        this.Cape2 = new ModelRenderer((ModelBase)this, 80, 13);
        this.Cape2.setRotationPoint(0.0f, 0.5f, -0.1f);
        this.Cape2.addBox(-5.4f, -0.1f, -3.25f, 10, 16, 7, 0.0f);
        ...
        this.Cape = new ModelRenderer((ModelBase)this, 79, 2);
        this.Cape.setRotationPoint(0.0f, 0.3f, 0.0f);
        this.Cape.addBox(-4.5f, -1.2f, -3.55f, 9, 2, 8, 0.0f);
        this.setRotateAngle(this.Cape, 0.091106184f, 0.0f, 0.0f);
        this.ShoulderL = new ModelRenderer((ModelBase)this, 0, 33);
        this.ShoulderL.mirror = true;
        this.ShoulderL.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.ShoulderL.addBox(-1.1f, -2.1f, -2.4f, 5, 4, 5, 0.0f);
        ...
        this.Hair.addChild(this.Head);
        this.Body.addChild(this.Cape2);
        this.Head.addChild(this.Cape);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        float n4 = par4;
        float n5 = par5;
        this.Hair.rotateAngleY = n4 / (r2 / (float)Math.PI);
        this.Hair.rotateAngleX = n5 / (r2 / (float)Math.PI);
        ...
        this.ArmR.rotateAngleX = -0.0f + MathHelper.cos((float)(par1 * 0.6662f)) * 0.3f * par2;
