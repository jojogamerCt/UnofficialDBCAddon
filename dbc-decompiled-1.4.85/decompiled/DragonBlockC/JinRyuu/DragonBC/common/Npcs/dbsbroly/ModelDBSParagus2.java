...
extends ModelBase {
    ...
    public ModelDBSParagus2() {
        ...
        this.Beard = new ModelRenderer((ModelBase)this, 28, 1);
        this.Beard.setRotationPoint(0.0f, -2.7f, -3.8f);
        this.Beard.addBox(-3.0f, -0.1f, -0.25f, 6, 5, 0, 0.0f);
        ...
        this.ShoulderL.addBox(-1.1f, -2.1f, -2.5f, 6, 4, 5, 0.0f);
        this.ShoulderR = new ModelRenderer((ModelBase)this, 0, 33);
        this.ShoulderR.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.ShoulderR.addBox(-4.9f, -2.1f, -2.5f, 6, 4, 5, 0.0f);
        this.Hair = new ModelRenderer((ModelBase)this, 0, 43);
        ...
        this.Bag = new ModelRenderer((ModelBase)this, 39, 3);
        this.Bag.setRotationPoint(3.5f, 9.0f, 0.0f);
        this.Bag.addBox(-0.6f, -0.9f, -2.3f, 2, 4, 5, 0.0f);
