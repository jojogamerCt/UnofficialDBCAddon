...
extends ModelBase {
    ...
    public ModelCheelai() {
        ...
        this.Bag = new ModelRenderer((ModelBase)this, 34, 3);
        this.Bag.setRotationPoint(-2.5f, 10.4f, 0.0f);
        this.Bag.addBox(-2.0f, -0.9f, -2.3f, 2, 4, 5, 0.0f);
        ...
        this.Scouter = new ModelRenderer((ModelBase)this, 51, 4);
        this.Scouter.setRotationPoint(0.0f, 1.4f, 0.0f);
        this.Scouter.addBox(2.2f, -6.5f, -1.6f, 2, 4, 3, 0.0f);
