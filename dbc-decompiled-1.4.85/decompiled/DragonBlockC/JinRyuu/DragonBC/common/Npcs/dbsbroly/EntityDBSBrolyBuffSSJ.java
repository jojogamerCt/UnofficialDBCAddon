...
extends EntityDBCEvil {
    ...
    public final int HePo = 300000;
    private int target;

    public EntityDBSBrolyBuffSSJ(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "dbsbrolybuffssj";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(300000.0);
