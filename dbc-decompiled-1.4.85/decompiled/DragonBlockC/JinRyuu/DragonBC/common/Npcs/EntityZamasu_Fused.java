...
extends EntityDBCEvil {
    ...
    public String tex;
    public final int AttPow = 24000;
    public final int HePo = 124000;
    private int target;

    public EntityZamasu_Fused(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "zamasu_fused";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(124000.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(24000.0);
    }
