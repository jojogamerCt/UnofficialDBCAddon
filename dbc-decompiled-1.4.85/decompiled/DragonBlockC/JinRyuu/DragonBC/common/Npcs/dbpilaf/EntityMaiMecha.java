...
public class EntityMaiMecha
extends EntityDBCEvil {
    public String tex;
    public final int AttPow = 30;
    public final int HePo = 110;

    public EntityMaiMecha(World par1World) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(110.0);
