...
extends ModelBase {
    ...
    public ModelShu() {
        ...
        this.Sword2.addBox(-3.9f, -2.0f, -0.7f, 0, 4, 2, 0.0f);
        this.tail3 = new ModelRenderer((ModelBase)this, 53, 10);
        this.tail3.setRotationPoint(0.0f, 0.0f, 4.2f);
        this.tail3.addBox(-1.0f, -0.9f, -0.6f, 2, 2, 3, 0.0f);
        this.Head_1 = new ModelRenderer((ModelBase)this, 32, 7);
        this.Head_1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Head_1.addBox(-1.5f, -2.9f, -5.9f, 3, 3, 2, 0.0f);
        this.LegR_1 = new ModelRenderer((ModelBase)this, 2, 53);
        this.LegR_1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LegR_1.addBox(-1.5f, 5.0f, -2.0f, 3, 2, 4, 0.0f);
        this.Head.addChild(this.EarR);
        this.Head.addChild(this.EarL);
        this.Body.addChild(this.Sword);
        this.LegL.addChild(this.LegL_1);
        this.tail1.addChild(this.tail2);
        this.Sword.addChild(this.Sword2);
        this.tail2.addChild(this.tail3);
        this.Head.addChild(this.Head_1);
        this.LegR.addChild(this.LegR_1);
    }
