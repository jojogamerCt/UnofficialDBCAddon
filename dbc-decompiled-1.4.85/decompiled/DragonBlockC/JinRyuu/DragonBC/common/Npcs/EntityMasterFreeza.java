...
public class EntityMasterFreeza
extends EntityDBCKami {
    public final int HePo = 20000;

    public EntityMasterFreeza(World par1World) {
        super(par1World);
        this.name = "Master Freeza";
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (this.isEntityAlive()) {
            par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 18, par1EntityPlayer.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            return true;
        }
