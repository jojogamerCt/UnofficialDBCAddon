...
extends EntityDBCEvil {
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/frost5.png";
    }

    @Override
    protected void applyEntityAttributes() {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(52000.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(7600.0);
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (!(var6 instanceof EntityFrost5)) continue;
                EntityFrost5 var7 = (EntityFrost5)var6;
