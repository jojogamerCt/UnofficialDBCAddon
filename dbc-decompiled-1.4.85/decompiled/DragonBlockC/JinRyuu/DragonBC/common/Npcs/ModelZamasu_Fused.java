...
extends ModelBase {
    ...
    public ModelZamasu_Fused() {
        ...
        this.HairL.addBox(2.0f, -11.5f, -3.9f, 2, 7, 5, 0.0f);
        this.setRotateAngle(this.HairL, 0.0f, 0.045378562f, 0.07853982f);
        this.BarrierofLight = new ModelRenderer((ModelBase)this, 62, 9);
        this.BarrierofLight.setRotationPoint(0.0f, 0.0f, 7.8f);
        this.BarrierofLight.addBox(-16.5f, -22.6f, 0.0f, 33, 42, 0, 0.0f);
        ...
        this.HairR.addBox(-3.9f, -11.4f, -3.3f, 2, 7, 5, 0.0f);
        ...
        this.HairBase.addBox(-2.9f, -11.6f, -4.0f, 6, 6, 7, 0.0f);
        ...
        this.Body1.addChild(this.BarrierofLight);
