...
extends EntityDBCEvil {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(4400.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(440.0);
    }
    ...
    public void onDeath(DamageSource par1DamageSource) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (!(var6 instanceof EntityFreezaSoldier3)) continue;
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                Entity var6 = (Entity)var4.get(var5);
                if (var6 instanceof EntityFreezaFather) {
                    var7 = (EntityFreezaFather)var6;
                    ((EntityFreezaFather)var7).becomeAngryAt(var3);
                }
                if (!(var6 instanceof EntityFreezaSoldiers)) continue;
                var7 = (EntityFreezaSoldiers)var6;
                ((EntityFreezaSoldiers)var7).becomeAngryAt(var3);
            }
            this.becomeAngryAt(var3);
        }
