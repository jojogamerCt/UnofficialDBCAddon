...
extends EntityDBCEvil {
    ...
    public final int HePo = 104000;
    private int target;

    public EntityBeerusMonaka(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "beerus_monaka";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(104000.0);
