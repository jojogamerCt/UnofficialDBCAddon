...
public class EntityZarbon2
extends EntityDBCEvil {
    public int randomSoundDelay = 0;
    public final int AttPow = 130;
    public final int HePo = 1300;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(1300.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(130.0);
    }
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/zarbon2.png";
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (!(var6 instanceof EntityZarbon2)) continue;
                EntityZarbon2 var7 = (EntityZarbon2)var6;
