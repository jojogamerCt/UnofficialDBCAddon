...
extends ModelBase {
    ...
    public ModelAndroid8() {
        ...
        this.LegL = new ModelRenderer((ModelBase)this, 50, 36);
        this.LegL.mirror = true;
        this.LegL.setRotationPoint(3.3f, 10.0f, 1.5f);
        ...
        this.LegR = new ModelRenderer((ModelBase)this, 50, 36);
        this.LegR.setRotationPoint(-3.3f, 10.0f, 1.5f);
        this.LegR.addBox(-3.0f, 0.0f, -3.0f, 6, 14, 6, 0.1f);
        this.ArmR1 = new ModelRenderer((ModelBase)this, 52, 12);
        this.ArmR1.setRotationPoint(-8.5f, -3.0f, 1.7f);
        this.ArmR1.addBox(-3.5f, -2.0f, -3.0f, 5, 15, 6, 0.0f);
        this.ArmL1 = new ModelRenderer((ModelBase)this, 52, 12);
        this.ArmL1.mirror = true;
        this.ArmL1.setRotationPoint(8.5f, -3.0f, 1.7f);
        ...
        this.Body1.addBox(-7.0f, 0.0f, -2.4f, 14, 8, 8, 0.0f);
