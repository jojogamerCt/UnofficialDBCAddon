...
extends ModelBase {
    ...
    public ModelJackieChun3() {
        ...
        this.Body3.addBox(-3.5f, 7.0f, -2.0f, 7, 3, 4, 0.0f);
        ...
        this.Body2.addBox(-3.1f, 5.5f, -1.5f, 6, 2, 3, 0.0f);
        ...
        this.Body.addBox(-3.5f, 0.0f, -2.0f, 7, 6, 4, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 28, 23);
        this.ArmR.setRotationPoint(-3.9f, 5.4f, 0.1f);
        ...
        this.ArmL.setRotationPoint(3.9f, 5.4f, 0.1f);
