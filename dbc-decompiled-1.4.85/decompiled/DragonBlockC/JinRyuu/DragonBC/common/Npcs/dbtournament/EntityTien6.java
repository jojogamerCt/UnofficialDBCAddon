...
public class EntityTien6
extends EntityDBCEvil {
    public String tex;
    public final int AttPow = 350;
    public final int HePo = 1200;

    public EntityTien6(World par1World) {
        super(par1World);
        this.experienceValue = 10;
        this.tex = "tien_shinhan_buusaga_b";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(350.0);
    }
