...
extends ModelBase {
    ...
    public ModelKingChappa() {
        ...
        this.Hair1 = new ModelRenderer((ModelBase)this, 35, 51);
        this.Hair1.setRotationPoint(0.0f, -6.3f, 1.7f);
        this.Hair1.addBox(-4.5f, -2.5f, -1.9f, 9, 7, 5, 0.0f);
        ...
        this.Hair2.setRotationPoint(0.0f, -6.5f, -0.6f);
        this.Hair2.addBox(-2.5f, -2.7f, -3.6f, 5, 3, 5, 0.0f);
        ...
        this.Cloth = new ModelRenderer((ModelBase)this, 1, 49);
        this.Cloth.setRotationPoint(0.0f, 9.0f, 0.4f);
        this.Cloth.addBox(-4.5f, 0.0f, -2.3f, 9, 10, 4, 0.0f);
