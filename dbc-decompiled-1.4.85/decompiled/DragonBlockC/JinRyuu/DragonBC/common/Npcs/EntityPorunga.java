...
extends EntityCreature {
    ...
    public EntityPorunga(World par1World) {
        ...
        this.width = 1.0f;
        this.height = 32.0f;
        this.tasks.addTask(0, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 6.0f));
        this.tasks.addTask(1, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 6.0f));
        ...
        this.tasks.addTask(8, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 6.0f));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (this.isEntityAlive()) {
            if (!this.worldObj.isRemote) {
                if (!this.granted) {
                    this.granted = true;
                    JRMCoreH.setInt((int)3, (EntityPlayer)par1EntityPlayer, (String)"jrmcWishes");
                    JRMCoreH.setInt((int)1, (EntityPlayer)par1EntityPlayer, (String)"jrmcDrgn");
                }
            } else if (!this.granted) {
                this.granted = true;
                par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 3, par1EntityPlayer.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            }
            if (!this.worldObj.isRemote) {
                EntityPorunga2 Dragon2 = new EntityPorunga2(par1EntityPlayer.worldObj);
                ...
                this.worldObj.spawnEntityInWorld((Entity)Dragon2);
            }
            this.setDead();
            return true;
        }
