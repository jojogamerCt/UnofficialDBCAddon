...
extends ModelBase {
    ...
    public ModelSorrel() {
        ...
        this.Scarf.addBox(-2.5f, -0.5f, -2.5f, 5, 1, 5, 0.0f);
        this.Hat2 = new ModelRenderer((ModelBase)this, 37, 48);
        this.Hat2.setRotationPoint(0.0f, 0.6f, -4.0f);
        this.Hat2.addBox(-4.0f, 0.0f, -2.0f, 8, 0, 2, 0.0f);
        this.setRotateAngle(this.Hat2, 0.33056536f, 0.0f, 0.0f);
        this.tail = new ModelRenderer((ModelBase)this, 23, 39);
        this.tail.setRotationPoint(0.0f, 8.4f, 1.8f);
        this.tail.addBox(-1.0f, -1.0f, -0.2f, 2, 2, 2, 0.0f);
        this.setRotateAngle(this.tail, -0.045553092f, 0.0f, 0.0f);
        this.Body1 = new ModelRenderer((ModelBase)this, 0, 17);
        this.Body1.setRotationPoint(0.0f, 2.6f, 0.0f);
        this.Body1.addBox(-3.0f, 0.0f, -1.9f, 6, 5, 4, -0.2f);
        this.Scarf2 = new ModelRenderer((ModelBase)this, 55, 16);
        this.Scarf2.setRotationPoint(1.0f, 0.2f, 2.4f);
        this.Scarf2.addBox(-1.4f, 0.0f, 0.0f, 3, 7, 0, 0.0f);
        this.setRotateAngle(this.Scarf2, 0.1675516f, 0.0f, 0.0f);
        this.Body2 = new ModelRenderer((ModelBase)this, 0, 27);
        this.Body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body2.addBox(-2.5f, 4.8f, -1.6f, 5, 3, 3, 0.0f);
        this.LegR2 = new ModelRenderer((ModelBase)this, 0, 41);
        this.LegR2.setRotationPoint(0.0f, 0.5f, 0.0f);
        this.LegR2.addBox(-2.0f, -0.3f, -2.5f, 4, 4, 5, 0.0f);
        this.setRotateAngle(this.LegR2, 0.0f, 0.0f, 0.04363323f);
        this.Hat1 = new ModelRenderer((ModelBase)this, 31, 51);
        this.Hat1.setRotationPoint(0.0f, -3.9f, 0.0f);
        this.Hat1.addBox(-4.0f, -3.4f, -4.0f, 8, 4, 8, 0.0f);
        this.setRotateAngle(this.Hat1, -0.09128072f, 0.089186326f, 0.0f);
        this.EarL = new ModelRenderer((ModelBase)this, 35, 1);
        this.EarL.mirror = true;
        this.EarL.setRotationPoint(3.1f, -5.7f, 0.0f);
        this.EarL.addBox(-2.0f, -8.5f, 0.0f, 4, 9, 0, 0.0f);
        ...
        this.LegL2.setRotationPoint(0.0f, 0.5f, 0.0f);
        this.LegL2.addBox(-2.0f, -0.3f, -2.5f, 4, 4, 5, 0.0f);
        this.setRotateAngle(this.LegL2, 0.0f, 0.0f, -0.04363323f);
        this.LegL = new ModelRenderer((ModelBase)this, 0, 51);
        this.LegL.mirror = true;
        this.LegL.setRotationPoint(1.8f, 12.0f, 0.0f);
        this.LegL.addBox(-1.6f, 3.2f, -2.0f, 3, 9, 4, -0.2f);
        this.Scarf3 = new ModelRenderer((ModelBase)this, 55, 23);
        this.Scarf3.setRotationPoint(0.0f, 6.8f, 0.0f);
        this.Scarf3.addBox(-1.4f, 0.0f, 0.0f, 3, 10, 0, 0.0f);
        this.setRotateAngle(this.Scarf3, 0.0837758f, 0.0f, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 23, 20);
        this.ArmR.setRotationPoint(-3.8f, 3.8f, 0.0f);
        this.ArmR.addBox(-1.7f, -1.3f, -1.8f, 3, 11, 4, -0.3f);
        this.setRotateAngle(this.ArmR, 0.0f, 0.0f, 0.06981317f);
        this.EarR = new ModelRenderer((ModelBase)this, 35, 1);
        this.EarR.setRotationPoint(-3.4f, -5.7f, 0.0f);
        this.EarR.addBox(-2.0f, -8.5f, 0.0f, 4, 9, 0, 0.0f);
        this.setRotateAngle(this.EarR, -0.17453292f, 0.0f, -0.08726646f);
        this.ArmL = new ModelRenderer((ModelBase)this, 38, 20);
        this.ArmL.setRotationPoint(3.8f, 3.8f, 0.0f);
        this.ArmL.addBox(-1.3f, -1.3f, -1.8f, 3, 11, 4, -0.3f);
        this.setRotateAngle(this.ArmL, 0.0f, 0.0f, -0.06981317f);
        this.Body1.addChild(this.Scarf);
        ...
        this.Scarf2.addChild(this.Scarf3);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.Scarf2.rotateAngleX = -0.15f - MathHelper.cos((float)(par1 * 0.6662f)) * 1.2f * par2;
        if (0.0f > this.Scarf2.rotateAngleX) {
            this.Scarf2.rotateAngleX *= -1.0f;
        }
        this.Scarf2.rotateAngleY = 0.0f;
        this.Scarf3.rotateAngleX = -0.15f - MathHelper.cos((float)(par1 * 0.6662f)) * 1.2f * par2;
        if (0.0f > this.Scarf3.rotateAngleX) {
            this.Scarf3.rotateAngleX *= -1.0f;
        }
        this.Scarf3.rotateAngleY = 0.0f;
