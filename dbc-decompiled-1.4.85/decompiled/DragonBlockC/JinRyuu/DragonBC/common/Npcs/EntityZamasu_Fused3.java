...
extends EntityDBCEvil {
    ...
    public String tex;
    public final int AttPow = 32000;
    public final int HePo = 132000;
    private int target;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(132000.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(32000.0);
    }
