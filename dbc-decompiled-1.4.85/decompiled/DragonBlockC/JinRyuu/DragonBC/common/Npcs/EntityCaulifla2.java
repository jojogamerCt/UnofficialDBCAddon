...
public class EntityCaulifla2
extends EntityDBCEvil {
    public int randomSoundDelay = 0;
    public String tex;
    public final int AttPow = 12000;
    public final int HePo = 70000;
    private int target;

    public EntityCaulifla2(World par1World) {
        super(par1World);
        this.experienceValue = 200;
        this.tex = "caulifla_ssj";
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(70000.0);
