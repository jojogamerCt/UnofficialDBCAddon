...
public class EntityDrum
extends EntityDBCEvil {
    public String tex;
    public final int AttPow = 270;
    public final int HePo = 800;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(800.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(270.0);
    }
