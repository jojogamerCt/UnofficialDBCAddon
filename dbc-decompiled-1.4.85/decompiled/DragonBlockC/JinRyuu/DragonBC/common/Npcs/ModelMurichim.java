...
extends ModelBase {
    ...
    public ModelMurichim() {
        ...
        this.Head2.addBox(-3.5f, -8.0f, -3.5f, 7, 4, 8, 0.0f);
        ...
        this.Head2_1.setRotationPoint(0.0f, 0.0f, -0.5f);
        this.Head2_1.addBox(-6.0f, -1.0f, -3.1f, 12, 2, 7, 0.0f);
        ...
        this.EarR.setRotationPoint(-3.1f, -3.2f, -0.8f);
        this.EarR.addBox(-2.0f, -2.8f, 0.0f, 2, 3, 0, 0.0f);
        ...
        this.EarL.setRotationPoint(3.1f, -3.2f, -0.8f);
        this.EarL.addBox(0.0f, -2.8f, 0.0f, 2, 3, 0, 0.0f);
        ...
        this.Body1.addChild(this.Head2_1);
