...
extends ModelBase {
    ...
    public ModelAngelCamparri() {
        ...
        this.Hair2 = new ModelRenderer((ModelBase)this, 31, 6);
        this.Hair2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hair2.addBox(-4.0f, -3.7f, 3.8f, 8, 2, 2, 0.0f);
        ...
        this.LegL2.addBox(-1.9f, 13.1f, -4.0f, 4, 2, 2, 0.0f);
        ...
        this.LegR2.addBox(-2.1f, 13.1f, -4.0f, 4, 2, 2, 0.0f);
        ...
        this.LegL.addBox(-1.9f, 0.0f, -2.0f, 4, 15, 4, 0.0f);
        ...
        this.Nose2 = new ModelRenderer((ModelBase)this, 24, 0);
        this.Nose2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Nose2.addBox(-0.5f, -2.3f, -4.8f, 1, 1, 2, 0.0f);
        ...
        this.Nose1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Nose1.addBox(-0.5f, -4.8f, -1.4f, 1, 2, 2, 0.0f);
