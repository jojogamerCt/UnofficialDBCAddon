...
extends EntityDBCEvil {
    ...
    public final int AttPow = 320;
    public final int HePo = 3200;
    int trans;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(3200.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(320.0);
    }
    ...
    public void onDeath(DamageSource par1DamageSource) {
        ...
        if (var3 instanceof EntityPlayer) {
            ((EntityPlayer)var3).addChatMessage(new ChatComponentTranslation(JRMCoreH.trlai((String)"dbc.itemFreeSagaFre.d.4.line1"), new Object[0]).setChatStyle(JRMCoreH2.styl_wht));
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                Entity var6 = (Entity)var4.get(var5);
                if (!(var6 instanceof EntityFreeza4)) continue;
                EntityFreeza4 var7 = (EntityFreeza4)var6;
                var7.becomeAngryAt(var3);
            }
            this.becomeAngryAt(var3);
        }
