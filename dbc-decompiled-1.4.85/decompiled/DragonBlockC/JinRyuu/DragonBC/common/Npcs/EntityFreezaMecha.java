...
extends EntityDBCEvil {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(5000.0);
    ...
    public void onDeath(DamageSource par1DamageSource) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (!(var6 instanceof EntityFreezaFather)) continue;
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (var6 instanceof EntityFreezaMecha) {
                    var7 = (EntityFreezaMecha)var6;
                    ((EntityFreezaMecha)var7).becomeAngryAt(var3);
                }
