...
extends EntityDBCEvil {
    ...
    public final int AttPow = 72;
    public final int HePo = 720;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(720.0);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(72.0);
    }
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/cui.png";
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (var3 instanceof EntityPlayer) {
            ...
            for (int var5 = 0; var5 < var4.size(); ++var5) {
                ...
                if (!(var6 instanceof EntityKiwi)) continue;
                EntityKiwi var7 = (EntityKiwi)var6;
