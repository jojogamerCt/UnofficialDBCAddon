...
extends ModelBase {
    ...
    public ModelBuuSuper_Ultimate() {
        ...
        this.Head2.setRotationPoint(0.0f, -6.1f, -2.4f);
        this.Head2.addBox(-1.5f, -4.2f, -1.0f, 3, 4, 3, 0.0f);
        this.setRotateAngle(this.Head2, -0.49392816f, 0.0f, 0.0f);
        this.Head = new ModelRenderer((ModelBase)this, 0, 0);
        this.Head.setRotationPoint(0.0f, -2.5f, 0.6f);
        this.Head.addBox(-4.0f, -7.4f, -4.1f, 8, 8, 8, -0.7f);
        ...
        this.ArmL.setRotationPoint(5.4f, -1.5f, 0.5f);
        ...
        this.Torso = new ModelRenderer((ModelBase)this, 21, 20);
        this.Torso.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Torso.addBox(-4.5f, 0.1f, -1.8f, 9, 7, 5, 0.0f);
        ...
        this.Body = new ModelRenderer((ModelBase)this, 19, 34);
        this.Body.setRotationPoint(0.0f, -2.7f, 0.0f);
        this.Body.addBox(-4.0f, 2.7f, -2.2f, 8, 6, 5, 0.0f);
        ...
        this.Hips = new ModelRenderer((ModelBase)this, 19, 50);
        this.Hips.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hips.addBox(-4.0f, 8.7f, -2.3f, 8, 3, 5, 0.0f);
        this.ArmR = new ModelRenderer((ModelBase)this, 46, 30);
        this.ArmR.setRotationPoint(-5.5f, -1.5f, 0.5f);
        this.ArmR.addBox(-2.8f, -1.3f, -1.8f, 4, 12, 4, -0.2f);
