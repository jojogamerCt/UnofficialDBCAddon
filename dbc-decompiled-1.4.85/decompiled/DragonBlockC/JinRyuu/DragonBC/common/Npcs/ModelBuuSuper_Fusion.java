...
extends ModelBase {
    ...
    public ModelBuuSuper_Fusion() {
        ...
        this.ArmR.setRotationPoint(-5.2f, -1.4f, 0.5f);
        this.ArmR.addBox(-2.9f, -1.3f, -1.8f, 4, 12, 4, -0.2f);
        this.JacketL = new ModelRenderer((ModelBase)this, 35, 54);
        this.JacketL.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.JacketL.addBox(3.9f, -0.1f, -1.5f, 2, 4, 5, 0.0f);
        ...
        this.JacketL_1 = new ModelRenderer((ModelBase)this, 48, 48);
        this.JacketL_1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.JacketL_1.addBox(2.6f, 0.6f, -2.4f, 2, 5, 5, 0.0f);
        this.JacketNeck = new ModelRenderer((ModelBase)this, 18, 50);
        this.JacketNeck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.JacketNeck.addBox(-3.5f, -0.2f, 0.3f, 7, 2, 4, 0.0f);
        ...
        this.Torso.addBox(-4.5f, 0.6f, -1.4f, 9, 5, 4, 0.0f);
        ...
        this.Body.addBox(-3.5f, 3.1f, -2.2f, 7, 7, 4, 0.0f);
        this.ArmL = new ModelRenderer((ModelBase)this, 46, 30);
        this.ArmL.mirror = true;
        this.ArmL.setRotationPoint(5.3f, -1.4f, 0.5f);
        this.ArmL.addBox(-1.2f, -1.3f, -1.8f, 4, 12, 4, -0.2f);
        this.JacketR_1 = new ModelRenderer((ModelBase)this, 48, 48);
        this.JacketR_1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.JacketR_1.addBox(-4.6f, 0.6f, -2.4f, 2, 5, 5, 0.0f);
        this.Head2 = new ModelRenderer((ModelBase)this, 25, 0);
        this.Head2.setRotationPoint(0.0f, -6.1f, -1.5f);
        ...
        this.Neck = new ModelRenderer((ModelBase)this, 4, 16);
        this.Neck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Neck.addBox(-2.5f, -0.3f, -0.5f, 5, 2, 3, 0.0f);
        this.JacketR = new ModelRenderer((ModelBase)this, 35, 54);
        this.JacketR.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.JacketR.addBox(-5.9f, -0.1f, -1.5f, 2, 4, 5, 0.0f);
        this.Chest = new ModelRenderer((ModelBase)this, 0, 22);
        this.Chest.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Chest.addBox(-4.1f, 1.7f, -2.0f, 8, 3, 2, 0.0f);
        ...
        this.Head.addBox(-4.0f, -7.5f, -3.3f, 8, 8, 8, -0.7f);
        ...
        this.JacketNeck.addChild(this.JacketL);
        this.JacketL.addChild(this.JacketL_1);
        this.Body.addChild(this.JacketNeck);
        this.LegL.addChild(this.FootL);
        this.Body.addChild(this.Torso);
        this.LegR.addChild(this.FootR);
        this.JacketR.addChild(this.JacketR_1);
        this.Head.addChild(this.Head2);
        this.Head3.addChild(this.Head4);
        this.Head5.addChild(this.Head6);
        this.Body.addChild(this.Neck);
        this.JacketNeck.addChild(this.JacketR);
