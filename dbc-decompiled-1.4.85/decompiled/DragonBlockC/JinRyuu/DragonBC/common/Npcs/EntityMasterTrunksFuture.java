...
extends EntityDBCKami {
    ...
    public EntityMasterTrunksFuture(World par1World) {
        super(par1World);
        this.name = "Master Future Trunks";
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (this.isEntityAlive()) {
            par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 23, par1EntityPlayer.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            return true;
        }
    ...
    public String getTexture() {
        return "jinryuudragonbc:npcs/trunks1.png";
    }
