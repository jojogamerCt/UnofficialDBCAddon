...
extends ModelBase {
    ...
    public ModelJiren_Full_Power() {
        ...
        this.Body1.setRotationPoint(0.0f, -8.5f, 0.0f);
        this.Body1.addBox(-7.5f, 0.0f, -3.3f, 15, 8, 7, 0.0f);
        this.ArmR1 = new ModelRenderer((ModelBase)this, 63, 5);
        this.ArmR1.setRotationPoint(-8.0f, -5.2f, 0.0f);
        this.ArmR1.addBox(-5.3f, -3.3f, -3.0f, 6, 6, 7, 0.0f);
        this.LegL = new ModelRenderer((ModelBase)this, 41, 41);
        this.LegL.mirror = true;
        this.LegL.setRotationPoint(3.0f, 8.5f, 0.0f);
        this.LegL.addBox(-3.0f, 0.0f, -3.0f, 6, 16, 6, 0.0f);
        this.Body2 = new ModelRenderer((ModelBase)this, 0, 34);
        this.Body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body2.addBox(-6.0f, 6.0f, -3.5f, 12, 6, 6, 0.0f);
        ...
        this.LegR.setRotationPoint(-3.0f, 8.5f, 0.0f);
        this.LegR.addBox(-3.0f, 0.0f, -3.0f, 6, 16, 6, 0.0f);
        this.ArmL3 = new ModelRenderer((ModelBase)this, 67, 31);
        this.ArmL3.mirror = true;
        this.ArmL3.setRotationPoint(0.0f, 4.3f, -0.2f);
        this.ArmL3.addBox(-2.5f, 0.0f, -1.8f, 5, 9, 5, 0.0f);
        this.TornCloth = new ModelRenderer((ModelBase)this, 68, 48);
        this.TornCloth.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.TornCloth.addBox(-6.5f, 12.4f, -3.5f, 13, 1, 7, 0.0f);
        this.ArmR3 = new ModelRenderer((ModelBase)this, 67, 31);
        this.ArmR3.setRotationPoint(0.0f, 4.3f, -0.2f);
        this.ArmR3.addBox(-2.5f, 0.0f, -1.9f, 5, 9, 5, 0.0f);
        this.Chest = new ModelRenderer((ModelBase)this, 38, 33);
        this.Chest.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Chest.addBox(-6.0f, 1.2f, -4.1f, 12, 6, 1, 0.0f);
        ...
        this.ArmL1.setRotationPoint(8.0f, -5.2f, 0.0f);
        this.ArmL1.addBox(-0.7f, -3.3f, -3.0f, 6, 6, 7, 0.0f);
        this.Body1.addChild(this.Body2);
        this.Body2.addChild(this.Body3);
        this.Head.addChild(this.EarL);
        this.ArmL2.addChild(this.ArmL3);
        this.Body3.addChild(this.TornCloth);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GL11.glPushMatrix();
        float F = 1.1f;
        JGRenderHelper.modelScalePositionHelper((float)1.1f);
        this.LegL.render(f5);
        this.Head.render(f5);
