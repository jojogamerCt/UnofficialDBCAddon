...
public class x3WorldChunkManagerVegeta
extends WorldChunkManager {
    ...
    public x3WorldChunkManagerVegeta() {
        this.biomesToSpawnIn.addAll(allowedBiomes);
    }

    public x3WorldChunkManagerVegeta(long seed, WorldType worldType) {
        this();
    }

    public x3WorldChunkManagerVegeta(World world) {
