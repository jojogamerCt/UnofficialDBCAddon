...
extends BiomeGenBaseDBC {
    ...
    public x1BiomeGenOW3(int par1) {
        ...
        this.customBiomeDecorator.OWtri3PerChunk = 1;
        this.customBiomeDecorator.yellowFlowersPerChunk = 10;
