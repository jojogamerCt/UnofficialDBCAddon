...
extends BlockSapling {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        ...
        return field_149881_b[MathHelper.clamp_int((int)p_149691_2_, (int)0, (int)5)];
    }
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_) {
        if (!TerrainGen.saplingGrowTree((World)p_149878_1_, (Random)p_149878_5_, (int)p_149878_2_, (int)p_149878_3_, (int)p_149878_4_)) {
            return;
        }
        int l = p_149878_1_.getBlockMetadata(p_149878_2_, p_149878_3_, p_149878_4_) & 7;
        WorldGenNamekTrees object = p_149878_5_.nextInt(10) == 0 ? new WorldGenNamekTrees(true) : new WorldGenNamekTrees(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        switch (l) {
            default: {
                object = new WorldGenNamekTrees(true);
            }
            case 1: 
        }
        ...
        if (!((WorldGenerator)object).generate(p_149878_1_, p_149878_5_, p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1)) {
            if (flag) {
                p_149878_1_.setBlock(p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1, (Block)this, l, 4);
                p_149878_1_.setBlock(p_149878_2_ + i1 + 1, p_149878_3_, p_149878_4_ + j1, (Block)this, l, 4);
                p_149878_1_.setBlock(p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1 + 1, (Block)this, l, 4);
                p_149878_1_.setBlock(p_149878_2_ + i1 + 1, p_149878_3_, p_149878_4_ + j1 + 1, (Block)this, l, 4);
            } else {
                p_149878_1_.setBlock(p_149878_2_, p_149878_3_, p_149878_4_, (Block)this, l, 4);
            }
        }
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        for (int i = 0; i < field_149881_b.length; ++i) {
            BlockDBCSaplings.field_149881_b[i] = par1IconRegister.registerIcon("jinryuudragonbc:tile.Block" + field_149882_a[i] + "Sapling");
        }
    }
