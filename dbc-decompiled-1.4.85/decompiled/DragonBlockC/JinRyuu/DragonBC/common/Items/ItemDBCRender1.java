...
import JinRyuu.DragonBC.common.Items.ItemDBCModel1;
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object ... data) {
        switch (type) {
            case INVENTORY: {
                ...
                GL11.glTranslatef((float)4.5f, (float)2.2f, (float)0.0f);
                JRMCoreClient.mc.renderEngine.bindTexture(new ResourceLocation(JRMCoreH.tjdbcAssts + ":textures/blades/D.png"));
                this.model.render();
            ...
            case ENTITY: {
                ...
                GL11.glTranslatef((float)-1.4f, (float)1.0f, (float)-0.2f);
                this.model.render();
                GL11.glDisable((int)3042);
                GL11.glPopMatrix();
                break;
