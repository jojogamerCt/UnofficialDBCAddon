...
extends GuiButton {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            this.drawTexturedModalRect(this.xPosition, this.yPosition, 236 - k * 20, 0, this.width, this.height);
    ...
    protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            par1Minecraft.getTextureManager().bindTexture(txx);
            GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
            this.drawTexturedModalRect(this.xPosition, this.yPosition + (int)(this.sliderValue * (float)(this.height - 4)), 216, 0, 20, 2);
            this.drawTexturedModalRect(this.xPosition, this.yPosition + (int)(this.sliderValue * (float)(this.height - 4)) + 2, 216, 126, 20, 2);
        }
    }
